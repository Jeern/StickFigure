...
namespace C3.XNA
{
    ...
    public static class Primitives2D
    {
        ...
        private static Vector2 _pixelCenter;

        private static void CreateThePixel(SpriteBatch spriteBatch)
        {
            pixel = new Texture2D(spriteBatch.GraphicsDevice, 1, 1, false, SurfaceFormat.Color);
            pixel.SetData(new[] { Color.White });
            _pixelCenter = new Vector2(pixel.Width / 2f, pixel.Height / 2f);
        }
        ...
        public static void FillRectangleCentered(this SpriteBatch spriteBatch, Rectangle rect, Color color, float angle)
        {
            if (pixel == null)
            {
                CreateThePixel(spriteBatch);
            ...
            spriteBatch.Draw(pixel, rect, null, color, angle, _pixelCenter, SpriteEffects.None, 0);
        }
