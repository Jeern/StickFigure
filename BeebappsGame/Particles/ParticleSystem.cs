...
namespace Beebapps.Game.Particles
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        public void Clear()
        {
            foreach (Particle particle in _freeParticles)
            {
                particle.Lifetime = 0;
            }
        }
        ...
        /// </summary>
        protected int MinNumParticles { get; set; }
        protected int MaxNumParticles { get; set; }
       
        /// <summary>
        /// this controls the texture that the particle system uses. It will be used as
        /// an argument to ContentManager.Reset.
        /// </summary>
        ...
        /// </summary>
        protected float MinInitialSpeed { get; set; }
        protected float MaxInitialSpeed { get; set; }
        ...
        /// </summary>
        protected float MinRotationSpeed { get; set; }
        protected float MaxRotationSpeed { get; set; }
        ...
        /// </summary>
        protected float MinLifetime { get; set; }
        protected float MaxLifetime { get; set; }
        ...
        /// </summary>
        /// <param name="howManyEffects">the maximum number of particle effects that are expected on screen at once.</param>
        ...
        public override void Initialize()
        {
            ...
            _particles = new Particle[_howManyEffects * MaxNumParticles];
            _freeParticles = new Queue<Particle>(_howManyEffects * MaxNumParticles);
        ...
        protected override void LoadContent()
        {
            ...
            // load the texture....
            _texture = Game.Content.Load<Texture2D>(TextureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                BeebappsGame.Random.Next(MinNumParticles, MaxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity =
                BeebappsGame.RandomBetween(MinInitialSpeed, MaxInitialSpeed);
            float acceleration =
                BeebappsGame.RandomBetween(MinAcceleration, MaxAcceleration);
            float lifetime =
                BeebappsGame.RandomBetween(MinLifetime, MaxLifetime);
            float scale =
                BeebappsGame.RandomBetween(MinScale, MaxScale);
            float rotationSpeed =
                BeebappsGame.RandomBetween(MinRotationSpeed, MaxRotationSpeed);
        ...
        {
            float angle = BeebappsGame.RandomBetween(0, MathHelper.TwoPi);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (Particle p in _particles)
            {
                ...
                BeebappsGame.Current.SpriteBatch.Draw(_texture, p.Position, null, color,
                    p.Rotation, _origin, scale, SpriteEffects.None, 1f);
            }
